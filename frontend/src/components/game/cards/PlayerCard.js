const PlayerCard = (
  { 
   ...
   return (
      <div key={id} id={`own-card-${id}`} className="cont flex-row p-4 mt-4" style={{ boxShadow: `0 0 5px 5px ${color}`, filter: is_choose ? 'brightness(0.7)' : 'none', width: 'calc(25% - 0.75rem)'}}>
